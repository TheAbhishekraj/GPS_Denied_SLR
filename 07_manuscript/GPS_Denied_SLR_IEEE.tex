...
\textbf{1,692 peer-reviewed empirical studies} (2,000 initial $\rightarrow$
1,719 after deduplication $\rightarrow$ 1,692 included), following PRISMA~2020
...
(78\%, 1,332/1,700 extracted papers); (2)~\textbf{adversarial/EW denial is
...
\begin{enumerate}
  \item A PRISMA-compliant dataset of 1,692 included papers from 2,000
...
leaving \textbf{1,692 included papers}. A total of 1,700 records were
...
\begin{figure}[!t]
  ...
  \caption{PRISMA 2020 flow diagram. Initial: 2,000; after deduplication:
           1,719; after screening: 1,692; extracted: 1,700.}
  \label{fig:prisma}
\end{figure}
...
IMU appears in \textbf{1,332 of 1,700 papers (78\%)}
...
\begin{figure}[!t]
  ...
  \caption{Sensor modality frequency across all 1,700 extracted papers.
           IMU dominates at 78\%.}
...
\begin{table}[!t]
  ...
  \caption{Method Distribution and Validation Breakdown (N=1,700)}
...
\begin{figure}[!t]
  ...
  \caption{Operational application domains across the 1,700 surveyed papers.}
